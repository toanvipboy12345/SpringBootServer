...
//     @Column(name = "customer_name", nullable = true) // Thêm trường tên khách hàng
//     private String customerName;

//     @Column(name = "phone_number", nullable = true) // Thêm trường số điện thoại
...
//     public Order(String orderId, User user, double totalAmount, Address shippingAddress, ShippingMethod shippingMethod, String email, String customerName, String phoneNumber) {
//         this();
...
//         this.email = email;
//         this.customerName = customerName; // Thêm customerName vào constructor
//         this.phoneNumber = phoneNumber; // Thêm phoneNumber vào constructor
//     }
