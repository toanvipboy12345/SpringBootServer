...
public class OrderController {
    ...
    public ResponseEntity<List<InvoiceDTO>> getOrdersByPhoneNumber(@PathVariable String phoneNumber) {
        List<InvoiceDTO> invoiceDTOs = orderService.getOrdersByPhoneNumber(phoneNumber);
        if (invoiceDTOs.isEmpty()) {
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok(invoiceDTOs);
